...
trainPath = "../resource/rumoureval-2019-training-data"
testPath = "../resource/rumoureval-2019-test-data"
#labelPath = "../resource/"+obj+"_label_All.txt"
# since labels are in both 'rumoureval test' and 'training' data, they have to be extracted and combined into 1 dictionary
